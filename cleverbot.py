...
class Session(object):
        ...
        def __init__(self):
                ...
                self.MsgList=[]
		self.proxy = urllib2.ProxyHandler({'http': 'http://ee08b037:M@draa55@hproxy.iitm.ac.in:3128'})
		self.auth = urllib2.HTTPBasicAuthHandler()
		self.opener = urllib2.build_opener(self.proxy, self.auth, urllib2.HTTPHandler)
